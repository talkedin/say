...
/**
 * Menangani semua proses submit data post.
 * Termasuk menyimpan data ke dalam database.
 *
 * @package talkedin
 * @category Core System
 * @since Vesrsion Alfa 0.1 (September 2011)
 */
...
class Library_write {
    ...
    public function sanitize_post_title($title){
       return $this->request->strip_tags_attributes($title, '<em><i>');
    }
    ...
    private function allowed_tags(){
        ...
        return implode('', $allowedposttags);
    }
