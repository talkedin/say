 ...
 * EN: Website base url.
 */
$CONFIG['base_url']                         = 'http://talked.in/'; /* Change this with your application domain and/or path. */
...
$CONFIG['db']['default']['database']        = 'talked.in';
...
$CONFIG['session']['name']              = 'tsid';
$CONFIG['session']['cookie_expire']     = 0;
$CONFIG['session']['cookie_path']       = '/';
$CONFIG['session']['cookie_secure']     = false;
$CONFIG['session']['cookie_domain']     = '.'.$_SERVER['HTTP_HOST'];
...
$CONFIG['cache']['memcached']['driver'] = 'memcache';
